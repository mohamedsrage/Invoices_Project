                        ...
                        <div class="d-flex">
                            <div class="">
                                <h3 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ round(\App\Models\invoices::where('Value_Status', 2)->sum('Total'), 2) }}
                            ...
                            <span class="float-right my-auto mr-auto">
                                ...
                                <span class="text-white op-7">
                                    ...
                                    if($count_invoices2 == 0 || $count_all == 0){
                                       echo $count_invoices2 = 0;
                                    }
                                    else{
                                       echo $count_invoices2 = round($count_invoices2 / $count_all * 100, 2);
                                    }
                                    @endphp
                            ...
                            <span class="float-right my-auto mr-auto">
                                ...
                                <span class="text-white op-7">
                                    @php
                                        ...
                                        if($count_invoices1 == 0 || $count_all == 0){
                                           echo $count_invoices1 = 0;
                                        }
                                        else{
                                           echo $count_invoices1 = round($count_invoices1 / $count_all * 100, 2);
                                        }
                                    @endphp
                                </span>
                            </span>
